...
LANGSS="ca de es fr hu nl pl ru se sk"
...
IUSE="avahi debug doc examples +expat qt5 ssl static-libs zeroconf"
...
src_install() {
	...
	use doc && dohtml "Documentation/SwiftenDevelopersGuide/Swiften Developers Guide.xml"
}
